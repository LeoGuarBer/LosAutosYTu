...
// ======================================================
// 👉 AQUÍ PONDRÁS TU URL DE APPS SCRIPT DESPUÉS DE DEPLOY
// ======================================================

const URL_SHEETS = "https://script.google.com/macros/s/AKfycby2nUIqlYH1j-19mZPwhxe8HZ9zZwwalBAHcNNUpiG7s-34VKew-nqqvnyBFq0jUMt8/exec";
...
function enviarRespuestas() {
  ...
  fetch(URL_SHEETS, {
    method: "POST",
    mode: "no-cors",   // ✅ NECESARIO con Apps Script
    headers: {
...
.then(() => {
  console.log("Envío realizado (modo no-cors)");
  alert("Respuestas enviadas — revisa Google Sheets");
});
}
